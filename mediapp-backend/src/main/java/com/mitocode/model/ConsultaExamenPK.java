...
public class ConsultaExamenPK implements Serializable{
	...
	private static final long serialVersionUID = 1093186753744354223L;

	@ManyToOne
	@JoinColumn(name = "id_examen", nullable = false, foreignKey = @ForeignKey(name = "fk_consulta_examen"))
	private Examen examen;
	
	@ManyToOne
	@JoinColumn(name = "id_consulta", nullable = false, foreignKey = @ForeignKey(name = "fk_examen_consulta"))
