...
public class Paciente {
	...
	@ApiModelProperty(notes = "Nombres debe tener como mínimo 3 caracteres")
	@Size(min = 3, message = "Nombres debe tener como mínimo 3 caracteres")
	@Column(name="nombres", nullable = false, length = 70)
	private String nombres;
	
	@ApiModelProperty(notes = "Apellidos debe tener como mínimo 3 caracteres")
	...
	@ApiModelProperty(notes = "Ingresar un email válido")
	@Email
	@Column(name="email", nullable = false, length = 55)
	private String email;
	
	@ApiModelProperty(notes = "Dirección debe tener mínimo 3 caracteres")
